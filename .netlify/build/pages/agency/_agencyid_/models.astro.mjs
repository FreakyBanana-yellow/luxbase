...
import { l as listAgencyModels } from '../../../chunks/agency_CSgzl6Zn.mjs';
...
const $$Models = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Agentur \u2013 Models" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="max-w-5xl mx-auto px-4 py-10"> <h1 class="text-2xl font-semibold text-yellow-200 mb-4">Models</h1> ${renderComponent($$result2, "AgencyModelsTable", AgencyModelsTable, { "client:load": true, "agencyId": agencyId, "client:component-hydration": "load", "client:component-path": "C:/Users/Anwender/Downloads/luxbase-starter/src/components/AgencyModelsTable.jsx", "client:component-export": "default" })} </section> ` })}`;
