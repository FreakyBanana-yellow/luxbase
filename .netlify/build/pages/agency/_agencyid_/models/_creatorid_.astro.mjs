...
import 'kleur/colors';
import 'html-escaper';
import { $ as $$BaseLayout } from '../../../../chunks/BaseLayout_n2hMsNBN.mjs';
...
const $$creatorId = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Agentur \u2013 Profil (acting as)" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="max-w-5xl mx-auto px-4 py-10"> ${renderComponent($$result2, "ActingAsBanner", ActingAsBanner, { "client:load": true, "agencyName": agencyId, "creatorName": creatorName, "creatorEmail": creatorEmail, "client:component-hydration": "load", "client:component-path": "C:/Users/Anwender/Downloads/luxbase-starter/src/components/ActingAsBanner.jsx", "client:component-export": "default" })} <div class="mt-6 p-6 rounded-2xl bg-zinc-950/60 border border-yellow-600/20"> ${renderComponent($$result2, "ProfileForm", ProfileForm, { "client:load": true, "overrideCreatorId": creatorId, "agencyId": agencyId, "client:component-hydration": "load", "client:component-path": "C:/Users/Anwender/Downloads/luxbase-starter/src/components/ProfileForm.jsx", "client:component-export": "default" })} </div> </section> ` })}`;
