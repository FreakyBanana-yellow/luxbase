...
</p> <img src="/assets/screenshots/multiplattform.png" alt="Multiplattform Screenshot" class="rounded-xl border border-luxgray shadow-xl mx-auto mb-10 max-w-full"> <div class="text-left space-y-4 max-w-3xl mx-auto text-gray-400"> <p>✨ Inhalte nur 1× hochladen – und gleichzeitig auf mehreren Plattformen posten.</p> <p>🧠 Automatische Anpassung von Captions, Hashtags & Formaten.</p> <p>📅 Posts planen &amp; recyceln mit dem smarten Kampagnenmanager.</p> </div> </section> ` })}`;
